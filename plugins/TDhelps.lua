...
local telediamond2 = [[
- JσCKєяBσт <b> Fun Tolls for members  </b>- 

  🔊<b>Voice [text]</b>
  Convert text to Sound
  -E.G : Voice CyberShield Team-
  ➗<b>Calc [num]</b>
  get result of formule
  -E.G : Calc 9*9-
  🌧<b>Weather [city]</b>
  get [city]s weather
  -E.G : Weather karaj-
  🛣<b>togif [text]<b>
  send gif of the text
  -E.G : togif SPRCPU-
  👾<b>My [ID|Username|Photo|Number]</b>
  Retuns your ID|Username|Photo|Number
  👾<b>Info</b>
  Your info and profile photo
  👾<b>Pro [UserID]User target profile photo</b>
  🕐<b>Time</b>
  shows the time
  🤑<b>Nerkh</b>
  Return Groups Fee
  👽<b>Echo [text]</b>
  bot returns the text
  Echo> [filename.file exname] [text]
  get file from text
  🎎<b>Sticker (reply)</b>
  Convert File/photo to Sticker
  📎<b>File (reply)</b>
  Convert sticker/photo to File.png
  🌅<b>Photo (reply)</b>
  Convert File/sticker to photo
  - - - - - - - - - - - - - - - -
 <i> If plugins have bug report it by Feedback [text] Commands
  Use  /Linksupport To get the support group link</i>
 ]]
local telediamond4 = [[
